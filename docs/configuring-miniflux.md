...
See the [documentation](https://miniflux.app/docs/configuration.html) for a complete list of Miniflux's config options that you can put in `miniflux_environment_variables_additional_variables`.
